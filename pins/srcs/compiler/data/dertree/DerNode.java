...
public class DerNode extends DerTree {
	 ...
	 */
	public enum Nont {
		Source, Decls, DeclsRest, Decl,  Type, CompDecls, CompDeclsRest, CompDecl, Expr, CallsExpr, CallParamsRest,
		DisjExpr, DisjExprRest, ConjExpr, ConjExprRest, RelExpr, RelExprRest, AddExpr, AddExprRest, MulExpr, BinExpr, BracketExpr, CastExpr, CallExpr, CallParams, CallExprRest,
		MulExprRest, PrefExpr, PstfExpr, PstfExprRest, AtomExpr, CallEps, ArgsEps, Args, ArgsRest, CastEps, Op, ExprA, DeclsFirst, FunParamsRest, AssignStmt,
		WhereEps, Stmts, StmtsRest, Stmt, AssignEps, ElseEps, FunParams, FunParamsA, FunStmts, WhereStmt, StmtsA, DeclsA, ElseStmt, StmtB, StmtA, Epsilon, BinOp1, BinOp2, ExprC, ExprB, ExprEl, Unop, Literal, Exprs,
	};
